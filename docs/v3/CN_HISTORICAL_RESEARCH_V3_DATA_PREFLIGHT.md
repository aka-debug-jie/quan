...
- The third B00 attempt stopped on `sz000977@2020-03-19`, an evidenced rights issue at CNY 12.92 with actual ratio 0.1177945. Its earlier 2017 rights issue is also bound under the same no-participation rule. Evidence SHA-256 values are `574c1e93…c1b70` and `da48aa43…e331d`; no other unmatched factor event is exempted.
...
- Another executed path exposed `sh600803@2018-02-12`. The SSE issuance material identifies a CNY 9.33, 10-for-2.5 rights issue with 2018-02-01 record date and 2018-02-28 listing; it is bound to no participation with evidence `2ca30013…745f6`.
