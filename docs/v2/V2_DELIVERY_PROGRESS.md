...
| V2-010 External historical blind test | NO_FORMAL_DATA_QUALIFICATION; CLOSED | CNY/CSI500 contracts remain `PENDING_SOURCE_APPROVAL`. The GLOBAL_ETF_USD free path completed Yahoo archive audit `cf3d54…674f7`, public-entry capture `13232e…8f29`, direct-document capture `865dac…dc25` and source-bound templates. It stops because the NYSE document reports trading-day counts rather than daily sessions, issuer documents do not produce a complete seven-ETF 2025--2026 action ledger, and DBC has no inferred ledger. This is a formal V2 evidence closure, not a qualification, backtest or profitability result. See V2_NO_FORMAL_DATA_QUALIFICATION_CLOSURE.md. |
...
| Prospective CN shadow v1 | OPERATIONS_LOOP_RC; MIXED_PROSPECTIVE_INPUT | The separate forward-only AF-003 loop completed its first real free-source smoke on 2026-09-21. It archived 65 explicitly non-formal warm-start sessions plus one contemporaneous session, ranked 292 eligible CSI300 members, emitted Top20 and reconciled the CNY 1,000,000 engineering account; no opening fill was due. RC-02 adds prospective-branch CI, sell-before-buy execution, exact-calendar full-cross-section qualification, isolated formal paper accounting, canonical-receipt semantics and versioned corporate-action knowledge. Commit `9303a13` passed both remote CI jobs; redacted manifest `0a71c72f…6779` retains the hashes and boundaries. Final operations closure still requires a real T+1 fill, a natural sell-plus-buy rebalance and matching rebuild. `PROFITABILITY_STATUS` remains `INSUFFICIENT_PROSPECTIVE_EVIDENCE`; no live trading or historical qualification is implied. See V2_PROSPECTIVE_CN_SHADOW_V1.md. |
