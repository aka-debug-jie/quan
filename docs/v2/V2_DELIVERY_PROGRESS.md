...
| V2-003 PIT membership qualification | BLOCKED_DATA | The 2015-01-01--2026-09-10 CSI300 audit checked 852,600 member-sessions and found 15,743 missing/status-unknown sessions, with no OHLC, factor, file or binary-index failures. Free BaoStock status classification and SSE/SZSE official interval promotion are implemented next; Tushare is optional. |
