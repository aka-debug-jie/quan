...
| V2-010 External historical blind test | BLOCKED_DATA; GLOBAL_ETF_USD_INITIALIZED | CNY/CSI500 contracts remain `PENDING_SOURCE_APPROVAL`. The selected first path, GLOBAL_ETF_USD, now has an offline qualification receipt `0b982…a6fa96` that records the seven missing artifacts (approval, raw manifest, calendar, corporate actions, PIT membership, costs and reproduction). No source capture or historical return test has run. See V2_010_GLOBAL_ETF_USD_INITIAL_QUALIFICATION.md. |
