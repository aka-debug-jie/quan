...
| AF-003 combinations and fixed-model increment diagnostics | PREREGISTERED_PENDING_RESTRICTED_REPLAY | Fixed expanding training folds compare two simple score combinations, Ridge, ElasticNet, LightGBM and XGBoost only on the seven AF-002 candidates. No CSI500, portfolio return, parameter search or formal-status action is authorized. See AF_003_PROTOCOL.md. |
