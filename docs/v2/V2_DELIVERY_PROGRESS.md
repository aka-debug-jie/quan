...
| AF-002 walk-forward stability and redundancy | PREREGISTERED_PENDING_RESTRICTED_REPLAY | Four fixed chronological development folds, stability rules and redundancy rules are frozen against AF-001 identities. The approved Alpha158-only view has no industry or market-cap field; those diagnostics are explicitly unavailable and will not be inferred. No CSI500, portfolio, parameter-search or formal-status action is authorized. See AF_002_PROTOCOL.md. |
