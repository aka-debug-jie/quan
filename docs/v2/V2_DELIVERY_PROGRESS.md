...
| V2-010 External historical blind test | BLOCKED_DATA; NO_FREE_NORMALIZED_COVERAGE | CNY/CSI500 contracts remain `PENDING_SOURCE_APPROVAL`. The selected GLOBAL_ETF_USD free path completed Yahoo archive audit `cf3d54…674f7`, public-entry capture `13232e…8f29`, direct-document capture `865dac…dc25` and source-bound templates. It stops because the NYSE document reports trading-day counts rather than daily sessions, issuer documents do not produce a complete seven-ETF 2025--2026 action ledger, and DBC has no inferred ledger. This is a precise free-path closure, not a qualification or backtest. EODHD and other paid providers remain deferred. See V2_010_GLOBAL_ETF_USD_FREE_PATH_CLOSURE.md. |
