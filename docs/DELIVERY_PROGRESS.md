...
| 009 | `issue/009-walk-forward` | D0 close `686a626` | IN_PROGRESS | All frozen-universe assets qualified; deterministic execution, fold runner and immutable experiment registry | D0 PASS; locked test not run |
