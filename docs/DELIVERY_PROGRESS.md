...
| 008 | `issue/008-no-lookahead` | base `59d4226` | Implemented; acceptance review pending | T+1, ordering, and corporate-action PIT tests pass | Do not enter Issue 009 before review |
