...
def test_residual_requests_keep_exact_single_session_scope() -> None:
    """Each actual residual key becomes one small provider request."""
    ...
    assert requests == (
        ...
        ("sz000001", date(2020, 1, 2), date(2020, 1, 2)),
        ("sz000001", date(2020, 1, 6), date(2020, 1, 6)),
    )
